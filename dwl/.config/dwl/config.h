...
static const float rootcolor[]             = {0.141, 0.153, 0.227, 1.0}; /* #24273a - base */
static const float bordercolor[]           = {0.494, 0.549, 0.686, 1.0}; /* #7e8fab - overlay1 */
static const float focuscolor[]            = {0.541, 0.678, 0.957, 1.0}; /* #8aadf4 - blue (mauve) */
static const float urgentcolor[]           = {0.929, 0.529, 0.588, 1.0}; /* #ed8796 - red */
static const float fullscreen_bg[]         = {0.094, 0.102, 0.153, 1.0}; /* #181926 - crust */
...
static const Key keys[] = {
	...
	/* Basic window management - matching Hyprland */
	...
	{ MODKEY,                    XKB_KEY_f,          setlayout,      {.v = &layouts[2]} }, /* monocle/fullscreen */
	
	/* Window navigation - using arrow keys like Hyprland */
	...
	/* Also support j/k for vim-style navigation */
	{ MODKEY,                    XKB_KEY_j,          focusstack,     {.i = +1} },
	{ MODKEY,                    XKB_KEY_k,          focusstack,     {.i = -1} },
	
	/* Master/stack management */
	...
	{ MODKEY,                    XKB_KEY_j,          togglelayout,   {.v = &layouts[0]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_J,          togglelayout,   {.v = &layouts[1]} },
	...
	/* Workspace (tag) switching - 1-9 like Hyprland */
