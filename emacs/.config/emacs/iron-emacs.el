...
(use-package general
  ...
  (iron/leader-keys
    ...
    "f c" '((lambda () (interactive) (find-file "~/.config/emacs/iron-emacs.org")) :wk "[F]ind emacs [C]onfig")
    "f r" '(counsel-recentf :wk "[F]ind [R]ecent files")
 ...
 (iron/leader-keys
    ...
    "h r r" '((lambda () (interactive) (load-file "~/.config/emacs/init.el")) :wk "[R]eload emacs config"))
