...
-- options
local settings = type(vim.g.retro_future) == "table" and vim.g.retro_future or {}
...
local o = {
  theme           = get_opt("theme", "retro_future_theme", "pastel"),
  transparent     = get_opt("transparent", "retro_future_transparent", true),
  dim_inactive    = get_opt("dim_inactive", "retro_future_dim_inactive", true),
  italic_comments = get_opt("italic_comments", "retro_future_italic_comments", true),
  italic_keywords = get_opt("italic_keywords", "retro_future_italic_keywords", true),
  bold            = get_opt("bold", "retro_future_bold", true),
  high_contrast   = get_opt("high_contrast", "retro_future_high_contrast", false),
}
local function maybe(bg) return o.transparent and "NONE" or bg end

-- Pastel retro-futuristic colors
local pastel_colors = {
  black = "#2d2d3a",
  bg_dim = "#323248",
  bg0 = "#3a3a5a",
...
local function build_theme(name)
  local t = vim.tbl_extend("force", {}, pastel_colors)
...
local function apply()
  ...
  vim.g.colors_name = "retro_future"
  vim.cmd("hi clear")
