...
vim.opt.list = true
vim.opt.listchars = { tab = "» ", trail = "·", nbsp = "␣" } -- Indicate whitespace characters
...
vim.opt.inccommand = "split" -- Shows a preview of commands in new vertical split
...
vim.opt.virtualedit = "block" -- Allows positioning of cursor where there is no text
